...
public class MenuAdapter extends
    ...
    public MenuAdapter(Context context, LinkedList<String> foodList,
                       LinkedList<Integer> priceList, LinkedList<Integer> photoList){
    ...
    class MenuViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MenuViewHolder(final View itemView, MenuAdapter adapter) {
            super(itemView);
            foodItemView = itemView.findViewById(R.id.tv_food);
            priceItemView = itemView.findViewById(R.id.tv_price);
            photoItemView = itemView.findViewById(R.id.iv_photo);
